...
class ExpressionParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ExpressionParser#large_expression.
    def enterLarge_expression(self, ctx:ExpressionParser.Large_expressionContext):
        pass

    # Exit a parse tree produced by ExpressionParser#large_expression.
    def exitLarge_expression(self, ctx:ExpressionParser.Large_expressionContext):
        pass
    ...
    # Enter a parse tree produced by ExpressionParser#element.
    def enterElement(self, ctx:ExpressionParser.ElementContext):
        pass

    # Exit a parse tree produced by ExpressionParser#element.
    def exitElement(self, ctx:ExpressionParser.ElementContext):
        pass
